...
for i in range(55):
    j = stu_list[i][1]
    if j >= 90:
        final_list_A.append(stu_list[i])
    elif j >= 80:
        final_list_B.append(stu_list[i])
    elif j >= 70:
        final_list_C.append(stu_list[i])
    elif j >= 60:
        final_list_D.append(stu_list[i])
    else:
        final_list_E.append(stu_list[i])
final_list.append(final_list_A)
final_list.append(final_list_B)
final_list.append(final_list_C)
final_list.append(final_list_D)
